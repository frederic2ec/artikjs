export function igloo(array: { constructor: any }) {
  //constructor
  array.constructor;
}

export function cct(array: any[], ...args: any[]) {
  //Concat
  return array.concat(args);
}

export function cin(
  array: { copyWithin: (arg0: any[]) => any },
  ...args: any[]
) {
  //Copy Within
...
export function iter(array: any[]) {
  //Entries
  return array.entries();
}

export function all(array: any[], callback: (arg0: any) => any) {
  //select all members of the array
  return array.every((element: any) => callback(element));
}

export function fill(array: any[][], ...args: any[]) {
  //fills the array with the same static value for each members of the array
  return array.fill(args);
}

export function filter(array: any[], callback: (arg0: any) => any) {
  // idk how to describe this, you get it
  return array.filter((element: any) => callback(element));
}

export function aFind(array: any[], callback: (arg0: any) => any) {
  // pass a function that checks for an element in your array, and it will return the selected one
...
export function lindexOf(
  array: { lastindexOf: (arg0: any[]) => any },
  ...args: any[]
) {
